...
def position(data):
    ...
    # print(f'data enter listener "position" on server : {data}')
    # print(f'rooms_info in listener "position" on server : {rooms_info}')
    # print(f'coord in listener "position" on server : {new_coord}')
